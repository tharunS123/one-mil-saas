...
export default function LoginPage() {
    ...
    useEffect(() => {
        ...
        if (errorParam) {
            ...
            setError(messages[errorParam] || decodeURIComponent(errorParam));
        ...
        <div className="auth-container" style={{
            ...
            <div className="auth-branding" style={{
                ...
                <div>
                    <h1 style={{ fontSize: '2.5rem', fontWeight: 800, letterSpacing: '-0.04em', lineHeight: 1.1, marginBottom: 16, color: '#FFFFFF' }}>
                        Welcome<br />back<span style={{ color: 'var(--accent)' }}>.</span>
                    </h1>
                    <p style={{ color: 'rgba(255,255,255,0.5)', fontSize: '0.875rem', lineHeight: 1.7, maxWidth: 320 }}>
                        Sign in to manage your clients, track revenue, and grow your business.
                    </p>
                </div>
            ...
            <div className="auth-form-panel" style={{
                ...
                <div style={{ width: '100%', maxWidth: 400 }}>
                    <h2 style={{ marginBottom: 8, fontSize: '1.5rem' }}>Sign in</h2>
                    ...
                    <p style={{
                        ...
                        <Link href="/signup" style={{ color: 'var(--text-primary)', fontWeight: 700, borderBottom: '1px solid var(--accent)' }}>Create one</Link>
                    </p>
                </div>
            </div>
        </div>
